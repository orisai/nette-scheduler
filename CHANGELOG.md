...
## [Unreleased](https://github.com/orisai/nette-scheduler/compare/1.4.1...v1.x)

## [1.4.1](https://github.com/orisai/nette-scheduler/compare/1.4.0...1.4.1) - 2026-04-20
...
- Integrated functionality from `orisai/scheduler` 1.4.0
- `SchedulerExtension`
